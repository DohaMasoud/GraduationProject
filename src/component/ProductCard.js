...
function ProductCard({key2,desc,title,price,discount,rating,stock,brand,category,img}){
          ...
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-md-6 col-lg-3 col-xl-3 border-sm-start-none " style={{height:"fit-content",padding:"10px"}}>
                ...
                <NavLink to="/ProductAnalysis"  activeClassName="active-link" data-mdb-button-init data-mdb-ripple-init className="btn btn-primary btn-sm nav-link" type="button" onClick={()=>{IdHandler(key2)}}>Filter</NavLink>
                </div>
                </div>
                <span className="text-primary" style={{display:"block",textAlign:'center'}}><FaHeart/>save for later</span>
              </div>
            </div>
          </div>
        </div>
